		...
		<div class="col-sm-12">
			<div class="form-group text-left">
				<small>
					...
					<?php echo $infoObjetivoEstrategico[0]["id_estrategia"] . ' ' . $infoObjetivoEstrategico[0]["estrategia"]; ?>
					<br>
					<label class="control-label" for="descripcion">Descrición Estratégia: </label>
					<?php echo $infoObjetivoEstrategico[0]["descripcion_estrategia"]; ?>
					<br>
					<label class="control-label" for="objetivo_estrategico">Objetivo Estrategico: </label>
					<?php echo $infoObjetivoEstrategico[0]["numero_objetivo_estrategico"] . ' ' . $infoObjetivoEstrategico[0]["objetivo_estrategico"]; ?>
				</small>
			</div>
		</div>
	</div>
...
<?php
	$calificacion = $infoObjetivoEstrategico[0]["calificacion"];
	$observacion = $infoObjetivoEstrategico[0]["observacion"];
	$comentario = $infoObjetivoEstrategico[0]["comentario_supervisor"];
?>
	<form name="form" id="form" role="form" method="post" >
		<?php
			$arrParam = array(
                "numeroObjetivoEstrategico" => $infoObjetivoEstrategico[0]["numero_objetivo_estrategico"],
                "vigencia" => date("Y")
            );
		...
		?>
		<input type="hidden" id="hddId" name="hddId" value="<?php echo $infoObjetivoEstrategico?$infoObjetivoEstrategico[0]["numero_objetivo_estrategico"]:""; ?>"/>
