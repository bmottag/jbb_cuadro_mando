<div id="page-wrapper">
    <div class="row"><br>
		...
		<div class="col-md-12">
            <h3>
                Listado de Actividades que tiene a cargo
                <br><br>
                <small>
                    ...
                    ?>
                                <div class="col-lg-6">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <i class="fa fa-thumb-tack"></i> <strong>ACTIVIDAD No.  <?php echo $lista["numero_actividad"]; ?></strong><br>
                                            <?php echo $lista["descripcion_actividad"]; ?><br>
                                            <strong>Meta Plan Operativo Anual: </strong><?php echo $lista["meta_plan_operativo_anual"]; ?><br>
                                            ...
                                            ?><br><br>
                                            <p>                     
                                                <a class='btn btn-primary btn-xs' href='<?php echo base_url('dashboard/actividades/' . $lista["fk_id_cuadro_base"] .  '/' . $lista["numero_actividad"]); ?>'> <span class='fa fa-eye' aria-hidden='true'></span> Ver Detalle Actividad</a>
                                            </p>
                                        </div>
