...
$(function(){ 
	$(".btn-success").click(function () {	
            ...
            $.ajax ({
                type: 'POST',
				url: base_url + 'settings/cargarModalODS',
                data: {'idODS': oID},
                cache: false,
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-gear fa-fw"></i> CONFIGURACIÓN - ODS
					</h4>
				</div>
			</div>
		</div>
					...
					<div class="pull-right">
						<div class="btn-group">																				
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="x">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar ODS
							</button>
						</div>
					</div>
				</div>
					...
					<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
						...
						<?php
							foreach ($info as $lista):
									echo "<tr>";
									echo "<td class='text-center'>" . $lista['numero_ods'] . "</td>";
									echo "<td>" . $lista['ods'] . "</td>";
