...
<div class="modal-body">
	...
	<form name="form" id="form" role="form" method="post" >
		...
		<div class="row">
			<div class="col-sm-12">		
				<div class="form-group text-left">
					<label class="control-label" for="proyecto">Proyecto de Inversión: *</label>
					<input type="text" id="proyecto" name="proyecto" class="form-control" value="<?php echo $information?$information[0]["nombre_proyecto_inversion"]:""; ?>" placeholder="Proyecto de Inversión" required >
				</div>
			</div>
		</div>
